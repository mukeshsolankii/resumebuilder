...
$(".previous").click(function(){
    ...
    document.getElementById('myImg1').src='/images/step1r.png';
    document.getElementById('myImg2').src='/images/step2r.png';
    p=0;
	});
...
function btn_sub(){
	 console.log("In Main.js "+temp_num);
	 	document.getElementById('myImg2').src='/images/step2.png';
...
//Back button to form...
	...
	//Status images changes through this code...
	function statusImg(){
		document.getElementById('myImg1').src='/images/step1.png';
	}
